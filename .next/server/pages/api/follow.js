...
async function handler(req, res) {
    ...
    try {
        ...
        const user = await _libs_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.findUnique */ .Z.user.findUnique({
            where: {
                id: userId
            }
        });
        ...
        const updatedUser = await _libs_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.update */ .Z.user.update({
            where: {
                id: currentUser.id
            },
            data: {
...
var __webpack_exports__ = (__webpack_exec__(8277));

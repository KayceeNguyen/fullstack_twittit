...
async function handler(req, res) {
    ...
    try {
        ...
        const existingUser = await _libs_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.findUnique */ .Z.user.findUnique({
            where: {
                id: userId
            }
        });
        const followersCount = await _libs_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.count */ .Z.user.count({
            where: {
                followingIds: {
                    has: userId
                }
...
var __webpack_exports__ = (__webpack_exec__(7233));
